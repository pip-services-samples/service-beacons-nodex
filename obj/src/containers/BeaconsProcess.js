...
class BeaconsProcess extends pip_services3_container_nodex_1.ProcessContainer {
    constructor() {
        ...
        this.addFactory(new BeaconsServiceFactory_1.BeaconsServiceFactory());
        this.addFactory(new pip_services3_rpc_nodex_1.DefaultRpcFactory());
        this.addFactory(new pip_services3_swagger_nodex_1.DefaultSwaggerFactory());
    }
}
