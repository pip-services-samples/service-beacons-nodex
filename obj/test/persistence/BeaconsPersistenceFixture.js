...
class BeaconsPersistenceFixture {
    ...
    testGetWithFilters() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Filter by udi
            page = yield this._persistence.getPageByFilter(null, pip_services3_commons_nodex_1.FilterParams.fromTuples('udi', '00002'), new pip_services3_commons_nodex_2.PagingParams());
            assert.lengthOf(page.data, 1);
            // Filter by udis
            page = yield this._persistence.getPageByFilter(null, pip_services3_commons_nodex_1.FilterParams.fromTuples('udis', '00001,00003'), new pip_services3_commons_nodex_2.PagingParams());
