...
suite('BeaconsMongoDbPersistence', () => {
    ...
    setup(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        persistence.configure(pip_services3_commons_nodex_1.ConfigParams.fromTuples('connection.uri', mongoUri, 'connection.host', mongoHost, 'connection.port', mongoPort, 'connection.database', mongoDatabase));
